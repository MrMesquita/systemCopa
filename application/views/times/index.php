                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a title="Cadastrar time" data-toggle="tooltip" data-placement="bottom" href="<?= base_url('times/core/') ?>"><button class="btn btn-success">Novo +</button></a>
                        </div>
                        <div class="card-body">
                            <table class="table data_table">
                                ...
                                <tbody>
                                    <?php foreach ($times as $time) : ?>
                                        ...
                                        <div class="modal fade" id="time-<?= $time->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?= base_url($this->router->fetch_class() . '/del/' . $time->id)?>"><button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter">Sim, excluir</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
